...
- Project lifecycle modals with evidence placeholders for screenshots, demos, and case studies
...
- Replace placeholder project links with GitHub repos, live demos, or case studies.
